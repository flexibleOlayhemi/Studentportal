...
<div class="row">
   <div class="col-4">
        <form action="{{ route('student.selcourse',['student'=>$student])}}" method="POST" class="pb-5">
        ...
        <hr>
        <form action="{{ route('student.result',['student'=>$student])}}" method="post">
            @method('options')
                ...
                <div class="card-header">Registered Courses</div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 py-2">
                                    <form action="{{ route('student.remcourse',['student'=>$student])}}" method="post">
                                        @method('DELETE')
